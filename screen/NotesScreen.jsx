        ...
        <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between',flexWrap:'wrap',gap:8}}>
          ...
          <View style={{flexDirection:'row',gap:8}}>
            <TouchableOpacity onPress={()=>onEdit(note)} activeOpacity={0.75}
              ...
              <Text style={{fontSize:12,fontWeight:'700',color:accent}}>{t('notes_edit', '?? Edit')}</Text>
            </TouchableOpacity>
      ...
      {notes.length>0&&(
        <View style={{flexDirection:'row',alignItems:'center',marginHorizontal:20,marginBottom:16,borderRadius:14,borderWidth:1,paddingHorizontal:14,paddingVertical:10,backgroundColor:tk.surfaceEl,borderColor:tk.glassEdge}}>
          <View style={{marginRight:8}}>
            <ICONS.Search color={tk.textMuted} size={16} sw={2.25} />
          </View>
          ...
          {!!searchQuery&&<TouchableOpacity onPress={()=>setSearchQuery('')} activeOpacity={0.7} hitSlop={8}><ICONS.X color={tk.textMuted} size={16} sw={2.25} /></TouchableOpacity>}
        </View>
      )}
        ...
        {notes.length>0&&filtered.length===0&&(
          <View style={{alignItems:'center',paddingVertical:40}}>
            <View style={{marginBottom:14}}>
              <ICONS.Search color={tk.textMuted} size={36} sw={2.25} />
            </View>
