    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: tk.bg }} edges={['top']}>
      ...
      <View style={{
        ...
        <TouchableOpacity onPress={handleShare} activeOpacity={0.75}
          ...
          <ICONS.Share color={tk.textPrimary} size={18} sw={2.25} />
        </TouchableOpacity>
      </View>
          ...
          <View style={{ flex: 1, marginLeft: 14 }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 6, flexWrap: 'wrap' }}>
              <View style={{
                ...
                <ICONS.Crown color="#fff" size={11} sw={2.25} />
...
function VerificationChip({ verified, t }) {
  ...
  return (
    <View style={{
      ...
      <ICONS.ShieldCheck color="#fff" size={12} sw={2.25} />
      <Text style={{ color: '#fff', fontSize: 10, fontWeight: '900', letterSpacing: 0.5 }}>
        {verified
...
function ActionTile({ Icon, label, onPress, tk }) {
  return (
    <TouchableOpacity onPress={onPress} activeOpacity={0.78}
      ...
      <Icon color={BLUE} size={20} sw={2.25} />
  ...
  return (
    <View style={{
      ...
      <View style={{
        ...
        <ICONS.ShieldCheck color={BLUE} size={36} sw={2.25} />
      </View>
      <Text style={{
